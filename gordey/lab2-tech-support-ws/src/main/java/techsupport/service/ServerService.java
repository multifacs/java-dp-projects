 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://techsupport/", wsdlLocation = "http://localhost:8000/TechSupport?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERSERVICE_QNAME = new QName("http://techsupport/", "ServerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8000/TechSupport?wsdl");
    ...
    public Server getServerPort() {
        return super.getPort(new QName("http://techsupport/", "ServerPort"), Server.class);
    }
    ...
    public Server getServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://techsupport/", "ServerPort"), Server.class, features);
    }
