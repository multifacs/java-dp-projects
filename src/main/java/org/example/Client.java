...
public class Client {
    public static void main(String[] args) throws RemoteException, NotBoundException {
        ...
        final String UNIQUE_BINDING_NAME = "server.gameInterface";
        final ClientData data = new ClientData();

        GameInterface gameInterface = (GameInterface) registry.lookup(UNIQUE_BINDING_NAME);
    ...
    static boolean checkFirstNotCenter(ClientData data) {
    ...
    static boolean checkEmpty(ClientData data) {
