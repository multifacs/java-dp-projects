 ...
 *       &lt;sequence&gt;
 *         &lt;element name="return" type="{http://techassist/}request" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetRequestsResponse {
    ...
    protected List<Request> _return;
     ...
     * 
     */
    public List<Request> getReturn() {
        if (_return == null) {
            _return = new ArrayList<Request>();
        }
        return this._return;
    }
